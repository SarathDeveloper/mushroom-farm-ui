...
export const products: Product[] = [
  {
    ...
    compareAtPrice: 180,
    weight: "250g",
    image: "mushroom-farm/products/premium-oyster-mushroom-0",
    gallery: [
  ...
  },
  {
    ...
    price: 180,
    weight: "250g",
    image: "mushroom-farm/products/mixed-mushrooms-CNX65Zqk",
    gallery: [
  ...
  },
  {
    ...
    price: 120,
    weight: "200g",
    image: "mushroom-farm/products/organic-button-mushroom",
    gallery: [
  ...
  },
  {
    ...
    compareAtPrice: 290,
    weight: "200g",
    image: "mushroom-farm/products/shiitake-exotic-1",
    gallery: [
  ...
  },
  {
    ...
    price: 160,
    weight: "250g",
    image: "mushroom-farm/products/grey-oyster-mushroom-0",
    gallery: [
  ...
  },
  {
    ...
    price: 220,
    weight: "200g Jar",
    image: "mushroom-farm/products/mushroom-pickle",
    gallery: ["mushroom-farm/products/mushroom-pickle"],
    rating: 4.5,
    reviewCount: 39,
    tag: "New",
    stock: 50,
  ...
  },
  {
    ...
    price: 320,
    weight: "100g",
    image: "mushroom-farm/products/dried-shiitake",
    gallery: [
  ...
  },
  {
    ...
    compareAtPrice: 220,
    weight: "200g",
    image: "mushroom-farm/products/oyster-mushrooms-DUuUKbNY",
    gallery: [
      "mushroom-farm/products/oyster-mushrooms-DUuUKbNY",
  ...
  },
  {
    ...
    price: 140,
    weight: "200g",
    image: "mushroom-farm/products/button-mushrooms-Dj92oXDo",
    gallery: [
      "mushroom-farm/products/button-mushrooms-Dj92oXDo",
  ...
  },
  {
    ...
    price: 280,
    weight: "200g",
    image: "mushroom-farm/products/shiitake-mushrooms-BMfvtmoS",
    gallery: [
      "mushroom-farm/products/shiitake-mushrooms-BMfvtmoS",
    ],
    rating: 4.9,
  ...
  },
  {
    ...
    price: 180,
    weight: "100g Pack",
    image: "mushroom-farm/products/mushroom-masala-powder",
    gallery: ["mushroom-farm/products/mushroom-masala-powder"],
    rating: 4.6,
    reviewCount: 73,
    tag: "New",
    stock: 60,
  ...
  },
  {
    ...
    price: 150,
    weight: "50g Pack",
    image: "mushroom-farm/products/creamy-mushroom-soup",
    gallery: ["mushroom-farm/products/creamy-mushroom-soup"],
    rating: 4.5,
    reviewCount: 29,
    tag: "Quick Cook",
    stock: 45,
