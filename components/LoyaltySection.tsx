...
export function LoyaltySection() {
  return (
    <section className="py-20 bg-gradient-to-br from-[var(--color-primary-dark)] to-[#3d6b4f] relative overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <FadeIn className="text-center mb-14">
          <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 text-white/90 text-sm font-semibold mb-4">
        ...
        <FadeIn>
          <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 md:p-8 border border-white/10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {tiers.map((tier) => (
                <div key={tier.name} className="bg-white/5 rounded-xl p-4 border border-white/10 text-center">
        ...
        <FadeIn className="text-center mt-10">
          <Button asChild size="lg" className="rounded-full bg-white text-[var(--color-primary-dark)] hover:bg-secondary hover:scale-[1.02] px-8 font-semibold">
