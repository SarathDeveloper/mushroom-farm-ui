        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center mb-16 sm:mb-24">
            ...
            <FadeIn direction="left" className="space-y-5">
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="text-sm font-bold uppercase tracking-[0.2em] text-primary">How We Started</span>
                <span className="h-px w-8 bg-border" />
              </div>
              <h2 className="text-2xl sm:text-3xl font-extrabold font-heading text-foreground tracking-tight">
                Started small, grew big
              </h2>
              <p className="text-[var(--color-body)] leading-relaxed text-base sm:text-lg">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-0">
              <FadeIn direction="right" className="lg:col-span-2 relative min-h-[300px] sm:min-h-[400px] lg:min-h-[520px] overflow-hidden group/image">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent p-6 lg:hidden">
                  <span className="text-white/80 text-base font-medium uppercase tracking-wider">Owner</span>
                  <h3 className="text-3xl font-bold text-white font-heading">Mathesh</h3>
                </div>
              </FadeIn>
              <FadeIn direction="left" className="lg:col-span-3 p-5 sm:p-8 md:p-12 flex flex-col justify-center">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-sm font-bold uppercase tracking-[0.2em] text-primary">Meet Our Owner</span>
                </div>
                <h2 className="text-2xl sm:text-3xl font-extrabold font-heading text-foreground tracking-tight mb-2">
                  Mathesh
                </h2>
                <p className="text-base text-muted-foreground font-medium mb-6">Owner &amp; Main Farmer</p>
                ...
                <div className="relative bg-card rounded-2xl p-6 border border-border">
                  ...
                  <p className="text-foreground font-medium italic pl-8 leading-relaxed text-base sm:text-lg">
                  ...
                  <p className="text-sm text-muted-foreground mt-3 pl-8">— Mathesh</p>
                </div>
              </FadeIn>
            </div>
          </div>
          ...
          <FadeIn className="text-center mb-12">
            <div className="flex items-center justify-center gap-3 mb-3">
              ...
              <span className="text-sm font-bold uppercase tracking-[0.2em] text-primary">Values</span>
              <span className="h-px w-6 sm:w-8 bg-border" />
            </div>
            <h2 className="text-2xl sm:text-3xl font-extrabold font-heading text-foreground tracking-tight mb-4">What We Believe In</h2>
            ...
            {values.map((v, i) => (
              <FadeIn key={v.title} delay={i * 0.1} className="flex gap-5 p-6 rounded-2xl bg-secondary">
                ...
                <div>
                  ...
                  <p className="text-base text-[var(--color-body)]">{v.desc}</p>
                </div>
              </FadeIn>
            ))}
          </div>
